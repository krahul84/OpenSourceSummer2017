...
This is the entry point for the application.
    ...
    In this activity the Json objects are parsed and passed to the menu activity.
    It also gets our current location.

    entry-> splash activity -> menu activity -> individual menu activities
